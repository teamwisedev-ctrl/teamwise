  ...
  useEffect(() => {
    ...
    const initializeTossWidget = async () => {
      try {
        ...
        paymentWidget.renderAgreement(`#${agreementId}`, { variantKey: 'AGREEMENT' })
      ...
      {isModalOpen && (
        <div style={modalBackdropStyles}>
          <div style={modalContentStyles} className="glass-panel animate-fade-in">
            ...
            {!isWidgetLoaded && (
              <div
                style={{ padding: '60px 0', textAlign: 'center', color: 'var(--text-secondary)' }}
              >
                결제 모듈을 불러오는 중입니다...
              </div>
            )}
            ...
            <div
              id={containerId}
              style={{ background: 'white', borderRadius: '8px', minHeight: '300px' }}
            />
            <div
              id={agreementId}
              style={{
