      ...
      <section style={heroStyles}>
        <div className="container animate-slide-up" style={heroContainerStyles}>
          <div style={heroContentStyles}>
            ...
            <div style={{ marginTop: '20px', fontSize: '1rem', color: 'var(--text-secondary)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                ...
                복잡한 회원가입 없이 <strong style={{ color: 'var(--text-primary)', fontWeight: 600 }}>구글 계정으로 1초 만에 시작</strong>
            </div>
          </div>
