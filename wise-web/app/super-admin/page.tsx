        ...
        <div style={{ padding: '40px 24px', maxWidth: '1400px', margin: '0 auto' }}>
            <div style={{ marginBottom: '40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                    <Link href="/super-admin/inquiries" className="btn-secondary" style={{ padding: '10px 20px', fontSize: '0.9rem', border: '1px solid var(--accent-primary)', textDecoration: 'none', background: 'rgba(59, 130, 246, 0.1)', color: 'var(--accent-primary)', display: 'flex', alignItems: 'center', gap: '6px' }}>
                        💬 1:1 문의 관리
                    </Link>
                    <Link href="/admin" className="btn-secondary" style={{ padding: '10px 20px', fontSize: '0.9rem', border: '1px solid var(--border-color)', textDecoration: 'none', background: 'transparent', color: 'var(--text-primary)' }}>
                        ← 일반 대시보드로 돌아가기
                    </Link>
                </div>
            </div>
