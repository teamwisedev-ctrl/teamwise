        ...
        <div className="container animate-fade-in" style={{ padding: '80px 24px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            <div className="glass-panel" style={{ padding: '60px', maxWidth: '600px', width: '100%' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', fontSize: '1.2rem', marginBottom: '40px' }}>
                    {planId === 'pro_unlimited' ? '슈퍼셀러 무제한팩' : '쿠팡 무제한 연동'} 구독이 정상적으로 시작되었습니다.<br />
                    데스크톱 앱을 재시작하시거나 연동 버튼을 누르면 즉시 잠금이 해제됩니다.
                </p>
                <a href="/admin" className="btn-primary" style={{ padding: '16px 32px', fontSize: '1.1rem', display: 'inline-block' }}>
                    내 라이선스 대시보드로 이동
                </a>
            </div>
        </div>
