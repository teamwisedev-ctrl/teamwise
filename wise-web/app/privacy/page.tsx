    ...
    return (
        <div className="container animate-fade-in" style={{ paddingTop: '100px', paddingBottom: '100px' }}>
            <div className="glass-panel" style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 48px' }}>
                <h1 style={{ fontSize: '2.5rem', fontWeight: 800, marginBottom: '40px', textAlign: 'center', color: 'var(--text-primary)' }}>Mo2 개인정보처리방침</h1>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', color: 'var(--text-secondary)', lineHeight: 1.8, wordBreak: 'keep-all', fontSize: '1.05rem' }}>
                    ...
                    <section>
                        <h2 style={{ fontSize: '1.3rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '12px', borderBottom: '2px solid var(--border-color)', paddingBottom: '8px' }}>1. 개인정보의 처리 목적</h2>
                    ...
                    <section>
                        <h2 style={{ fontSize: '1.3rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '12px', borderBottom: '2px solid var(--border-color)', paddingBottom: '8px' }}>2. 수집하는 개인정보 항목</h2>
                    ...
                    <section>
                        <h2 style={{ fontSize: '1.3rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '12px', borderBottom: '2px solid var(--border-color)', paddingBottom: '8px' }}>3. 개인정보의 보유 및 이용 기간</h2>
                        <p>
                    ...
                    <section>
                        <h2 style={{ fontSize: '1.3rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '12px', borderBottom: '2px solid var(--border-color)', paddingBottom: '8px' }}>4. 제3자 제공 및 위탁</h2>
                        <p>
                    ...
                    <section>
                        <h2 style={{ fontSize: '1.3rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '12px', borderBottom: '2px solid var(--border-color)', paddingBottom: '8px' }}>5. 정보주체의 권리와 행사 방법</h2>
                        <p>
