      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
        ...
        <div className="glass-panel animate-slide-up delay-100 guide-step-card" style={stepCardStyles}>
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              Mo2 웹사이트에서 무료 플랜(Starter)으로 회원가입을 완료한 뒤,{' '}
              <a
                href="/download"
        ...
        <div className="glass-panel animate-slide-up delay-200 guide-step-card" style={stepCardStyles}>
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              앱 내 <strong>[도매처 관리]</strong> 메뉴로 이동하여 도매토피아 소싱처를 선택하고
              연결을 진행합니다. 별도의 복잡한 API 키 발급 없이도 간단하게 계정 연동 상태가{' '}
        ...
        <div className="glass-panel animate-slide-up delay-300 guide-step-card" style={stepCardStyles}>
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              앱 내 <strong>[내 마켓 관리]</strong> 메뉴에서 카페24를 선택합니다. 카페24 아이디를
              입력하고 연동하기 버튼을 누르면 브라우저 창이 열리며, 카페24 로그인 후 접근 권한을
              허용하면 단 3초 만에 원클릭 OAuth 연동이 완료됩니다.
            </p>
            <div
              style={{
                padding: '16px',
        ...
        <div className="glass-panel animate-slide-up delay-400 guide-step-card" style={stepCardStyles}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ color: 'var(--text-secondary)', lineHeight: 1.7, wordBreak: 'keep-all' }}>
              <strong>[상품 관리]</strong> 메뉴에서 원하는 마진율(예: 1.3 = 30% 마진)과 전송할
              카테고리를 설정한 후 <strong>&apos;동기화 시작&apos;</strong> 버튼을 클릭합니다. 앱이
