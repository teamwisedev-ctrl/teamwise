        ...
        >
          ...
          <div
            ...
            style={{
              ...
              borderRadius: '8px',
              cursor: 'pointer',
              background: activeTab === 'markets' ? 'rgba(59, 130, 246, 0.1)' : 'transparent',
              color: activeTab === 'markets' ? 'var(--accent-primary)' : 'var(--text-secondary)',
              fontWeight: activeTab === 'markets' ? 600 : 500,
              display: 'flex',
              alignItems: 'center',
              gap: '12px',
              transition: 'all 0.2s'
          ...
          <div
            ...
            style={{
              ...
              borderRadius: '8px',
              cursor: 'pointer',
              background: activeTab === 'sync' ? 'rgba(59, 130, 246, 0.1)' : 'transparent',
              color: activeTab === 'sync' ? 'var(--accent-primary)' : 'var(--text-secondary)',
      ...
      <div style={{ flex: 1, padding: '40px 48px', overflowY: 'auto' }}>
        ...
        >
          ...
          >
            ...
            >
              마스터 파이프라인(구글 시트)에 접근하여 상품을 기록하기 위해 안전하게 구글 계정을
              연결합니다.
            </p>
          ...
          <div
            className="glass-panel animate-slide-up"
            style={{ padding: '24px', background: '#fff', animationDelay: '0.1s' }}
          >
            <h3
              style={{
                fontSize: '1.2rem',
          ...
          <div
            className="glass-panel animate-slide-up"
            style={{ padding: '24px', background: '#fff', animationDelay: '0.2s' }}
          >
            <h3
              style={{
                fontSize: '1.2rem',
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      color: isError ? '#ef4444' : isSuccess ? '#10b981' : '#e2e8f0'
                    }}
                  >
